...
init_html=function (data){
	...
	$.each(data,function(index, object) {
		...
		_html += "<tr class='poid'  poid='"+object.id+"'><td align='center'>"+object.id+"</td>"+
					"<td align='center'>"+object.pname+"</td>"+
					"<td align='center'>"+object.width+"</td>"+
					"<td align='center'>"+object.height+"</td>"+
					"<td align='center'>"+
					'<a class="btn btn-primary btn-sm shiny" href=Admin-ads-pushAdsPos-adsPosId-'+object.id+'> <i class="fa fa-edit"></i>编辑</a>'+
  ...
  _this.init("Admin-ads-ajaxPosList");
